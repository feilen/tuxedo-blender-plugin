...
from .ui import BakePanel, Bake_Lod_Delete, Bake_Lod_New, Bake_Platform_Delete, Bake_Platform_List, Material_Grouping_UL_List, Material_Grouping_UL_List_Reload, Bake_Platform_New, Choose_Steam_Library, Open_GPU_Settings, ToolPanel, SmartDecimation
...
def register():
    ...
    bpy.utils.register_class(Material_Grouping_UL_List_Reload)
...
def unregister():
    ...
    bpy.utils.unregister_class(Material_Grouping_UL_List_Reload)
